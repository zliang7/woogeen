...
ninja-query-archive = $(addprefix $(NINJA_OUTDIR)/, $(filter %.a, $(call ninja-query, $(1))))
ninja-query-object = $(addprefix $(NINJA_OUTDIR)/, $(filter %.o, $(call ninja-query, $(1))))
...
include $(LOCAL_PATH)/sample/yunos.mk
endif
